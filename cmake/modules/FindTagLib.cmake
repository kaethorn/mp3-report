...
if(TAGLIBCONFIG_EXECUTABLE)
  ...
  string(REPLACE "." ";" TAGLIB_VERSION_COMPONENTS ${TAGLIB_VERSION})
  list(GET TAGLIB_VERSION_COMPONENTS 0 TAGLIB_VERSION_MAJOR)
  list(GET TAGLIB_VERSION_COMPONENTS 1 TAGLIB_VERSION_MINOR)
  if(TAGLIB_VERSION_MAJOR LESS "${TagLib_FIND_VERSION_MAJOR}" OR TAGLIB_VERSION_MINOR LESS "${TagLib_FIND_VERSION_MINOR}")
    message(STATUS "TagLib version too old: version searched :${TagLib_FIND_VERSION_MAJOR}.${TagLib_FIND_VERSION_MINOR}, found ${TAGLIB_VERSION_MAJOR}.${TAGLIB_VERSION_MINOR}")
     set(TAGLIB_FOUND FALSE)
  else(TAGLIB_VERSION_MAJOR LESS "${TagLib_FIND_VERSION_MAJOR}" OR TAGLIB_VERSION_MINOR LESS "${TagLib_FIND_VERSION_MINOR}")
  ...
  endif(TAGLIB_VERSION_MAJOR LESS "${TagLib_FIND_VERSION_MAJOR}" OR TAGLIB_VERSION_MINOR LESS "${TagLib_FIND_VERSION_MINOR}")
...
if(TAGLIB_FOUND)
  if(NOT Taglib_FIND_QUIETLY AND TAGLIBCONFIG_EXECUTABLE)
    message(STATUS "Taglib version ${TAGLIB_VERSION_MAJOR}.${TAGLIB_VERSION_MINOR} found: ${TAGLIB_LIBRARIES}")
